...
export default function Footer() {
  return (
    <footer className="site-footer">
      {/* Ajout des styles inline pour le centrage mobile */}
      <style>{`
        @media (max-width: 768px) {
          ...
          .social-links, .footer-payment-logos {
      ...
      <div className="footer-inner">
        <div className="footer-top">
          ...
          <div>
            ...
            <div className="footer-payment-logos" style={{ display: 'flex', flexWrap: 'wrap', gap: 8, alignItems: 'center' }}>
              <FooterWaveLogo />
              <FooterVisaLogo />
        ...
        <div className="footer-bottom" style={{ textAlign: 'center', marginTop: 60, borderTop: '1px solid rgba(255,255,255,0.05)', paddingTop: 30 }}>
